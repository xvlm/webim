...
;(function($, window, document,undefined) {
    ...
    var Slide = function(ele, opt) {
        ...
        this.defaults = {
        	...
        	vOffset: 5,
            vSpace : 5,
            imgName : ['./static/codeimg/1.png','/static/codeimg/2.png'],
            imgSize : {
	        	width: '400px',
	        	height: '200px',
	        },
    ...
    Slide.prototype = {
        ...
        loadDom : function() {
        	...
        	if(this.options.type != 1) {		//图片滑动
        		panelHtml += '<div class="verify-img-panel" ><div class="verify-gap"></div></div>';
        		tmpHtml = '<div  class="verify-sub-block"></div>';
        	}



        	panelHtml += '<div class="verify-bar-area"><span  class="verify-msg">向右滑动完成验证</span><div class="verify-left-bar"><span class="verify-msg"></span><div  class="verify-move-block"><i  class="fa fa-angle-double-right"></i>'+tmpHtml+'</div></div></div>';
        	this.$element.html('<div class="aaa">'+panelHtml +'</div>');
        	this.htmlDoms = {
        ...
        start: function(e) {
        	...
        	this.htmlDoms.move_block.css('background-color', '#3e8ff7');
        	this.htmlDoms.left_bar.css('border-color', '#3e8ff7');
        	...
        	if(this.status) {
        		...
        		if(this.options.type != 1) {		//图片滑动
		            ...
		            if(parseInt(this.htmlDoms.gap.css('left')) >= (parseInt(this.htmlDoms.move_block.css('left')) - vOffset) && parseInt(this.htmlDoms.gap.css('left')) <= (parseInt(this.htmlDoms.move_block.css('left')) + vOffset)) {
		            	this.htmlDoms.move_block.css('background-color', '#10c36c');
		            	this.htmlDoms.left_bar.css({'border-color': '#10c36c', 'background-color': '#fff'});
		            	this.htmlDoms.icon.css('color', '#fff');
		            	...
		            	this.htmlDoms.move_block.css('background-color', '#ff4c52');
		            	this.htmlDoms.left_bar.css('border-color', '#ff4c52');
		            	this.htmlDoms.icon.css('color', '#fff');
		            	this.htmlDoms.icon.removeClass('icon-right');
        			...
        			if(parseInt(this.htmlDoms.move_block.css('left')) >= (parseInt(this.setSize.bar_width) - parseInt(this.options.barSize.height) - parseInt(this.options.vOffset))) {
        				this.htmlDoms.move_block.css('background-color', '#10c36c');
        				this.htmlDoms.left_bar.css({'color': '#4cae4c', 'border-color': '#10c36c', 'background-color': '#fff' });
        				this.htmlDoms.icon.css('color', '#fff');
		            	this.htmlDoms.icon.removeClass('icon-right');
		            	this.htmlDoms.icon.addClass('icon-check');
		            	this.htmlDoms.refresh.hide();
