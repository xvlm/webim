;(function(main) {
    ...
    Circle.prototype = {
        ...
        render: function(ctx) {
            ...
            ctx.fillStyle = 'hsla(' + this.hue + ', 60%, 50%, 1)';
            ctx.translate(this.x, this.y);
            ctx.beginPath();
            ...
            if(clickToggle) {
                ctx.save();
                ctx.strokeStyle = 'hsla(' + this.hue + ', 60%, 50%, 1)';
                ctx.beginPath();
    ...
    txtCtx.fillText('秀乐科技', WIDTH / 2, HEIGHT / 2);

    ctx.font = '18px Monospace';
    ctx.textAlign = 'center';
    ctx.baseline = 'middle';

    imgData = txtCtx.getImageData(0, 120, WIDTH, HEIGHT).data;
    ...
    requestAnimationFrame(function loop() {
        ...
        // ctx.fillStyle = 'white';
        // ctx.fillText('点击进入', WIDTH / 2, HEIGHT / 2 + 100);
